...
namespace _422_Nikiforova.Pages
{
    ...
    public partial class DiagrammPage : Page
    {
        ...
        private void ExcelButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            decimal grandTotal = allUsers.Sum(user => user.Payment.Sum(payment => payment.Price * payment.Num));
        ...
        private void WordButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (var user in allUsers)
            {
                ...
                application.Visible = true;
                document.SaveAs2(@"C:\Users\juli1\OneDrive\Рабочий стол\колледж\4 курс\уп1 Аксенова\Документы\Payments.docx");
                document.SaveAs2(@"C:\Users\juli1\OneDrive\Рабочий стол\колледж\4 курс\уп1 Аксенова\Документы\Payments.pdf", Word.WdExportFormat.wdExportFormatPDF);
            }
